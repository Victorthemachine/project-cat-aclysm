...
const ZWS = '\u200B';
/**
 * Basically this is a menudocs embed, I believe I abused it for lyrics but it should be rewritten to server the purpose
 */
module.exports = class NyaBotEmbed extends MessageEmbed {
